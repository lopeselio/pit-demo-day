...
class App extends Component {
  ...
  constructor(props) {
    ...
    async getBalance() {
      const provider = 'https://api.baobab.klaytn.net:8651';
      const web3 = new Web3(new Web3.providers.HttpProvider(provider));
      const token = '0xf10F9fd0Dd40c934FE5d19CE2Fb32b1b22540bF3';
      const wallet = '0xbE8Ace29e3022CD6841821315F82a6C2484fE585';
      const minABI = [
        {
            constant: true,
    ...
    const contract = new web3.eth.Contract(minABI, token);
      ...
      //  this.setState({ coin: Number(format.toString()) })
      this.setState({ coin: format })
      ...
      <div className="screen">
        ...
        <nav className="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
          ...
          <ul className='navbar-nav px-3'>
            ...
            <li>
            <small className='text-white'><span id='account' className='text-header1'>Dungeon Tokens Accumulated: {this.state.coin}</span></small>
        ...
        <div className='nft-sec container-fluid mt-5'>
          ...
          <div>
          <li className="nav-item text-nowrap d-none d-sm-none d-sm-block">
              <small className='text-white'><span id='account' className='text-header1'>Connected account: {this.state.account}</span></small>
          </li>
          </div>
          <div className='row'>
